...
---
- name: Deploy web application on multiple hosts
  hosts: all
  become: yes
...
helm install pravin-redis bitnami/redis
  --set architecture=replication \
  --set auth.enabled=true \
  --set auth.password=mystrongpassword \
  --set persistence.enabled=true \
